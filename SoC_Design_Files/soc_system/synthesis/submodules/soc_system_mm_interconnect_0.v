...
module soc_system_mm_interconnect_0 (
		...
		output wire [1:0]  BT_Key_s1_address,                                                   //                                                     BT_Key_s1.address
		input  wire [31:0] BT_Key_s1_readdata,                                                  //                                                              .readdata
		output wire [2:0]  HC05_UART_s1_address,                                                //                                                  HC05_UART_s1.address
		output wire        HC05_UART_s1_write,                                                  //                                                              .write
		output wire        HC05_UART_s1_read,                                                   //                                                              .read
		input  wire [15:0] HC05_UART_s1_readdata,                                               //                                                              .readdata
		output wire [15:0] HC05_UART_s1_writedata,                                              //                                                              .writedata
		output wire        HC05_UART_s1_begintransfer,                                          //                                                              .begintransfer
		output wire        HC05_UART_s1_chipselect,                                             //                                                              .chipselect
	...
	wire  [116:0] onchip_memory2_0_s1_agent_rf_source_data;                 // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;              // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire   [31:0] bt_key_s1_agent_m0_readdata;                              // BT_Key_s1_translator:uav_readdata -> BT_Key_s1_agent:m0_readdata
	wire          bt_key_s1_agent_m0_waitrequest;                           // BT_Key_s1_translator:uav_waitrequest -> BT_Key_s1_agent:m0_waitrequest
	wire          bt_key_s1_agent_m0_debugaccess;                           // BT_Key_s1_agent:m0_debugaccess -> BT_Key_s1_translator:uav_debugaccess
	wire   [20:0] bt_key_s1_agent_m0_address;                               // BT_Key_s1_agent:m0_address -> BT_Key_s1_translator:uav_address
	wire    [3:0] bt_key_s1_agent_m0_byteenable;                            // BT_Key_s1_agent:m0_byteenable -> BT_Key_s1_translator:uav_byteenable
	wire          bt_key_s1_agent_m0_read;                                  // BT_Key_s1_agent:m0_read -> BT_Key_s1_translator:uav_read
	wire          bt_key_s1_agent_m0_readdatavalid;                         // BT_Key_s1_translator:uav_readdatavalid -> BT_Key_s1_agent:m0_readdatavalid
	wire          bt_key_s1_agent_m0_lock;                                  // BT_Key_s1_agent:m0_lock -> BT_Key_s1_translator:uav_lock
	wire   [31:0] bt_key_s1_agent_m0_writedata;                             // BT_Key_s1_agent:m0_writedata -> BT_Key_s1_translator:uav_writedata
	wire          bt_key_s1_agent_m0_write;                                 // BT_Key_s1_agent:m0_write -> BT_Key_s1_translator:uav_write
	wire    [2:0] bt_key_s1_agent_m0_burstcount;                            // BT_Key_s1_agent:m0_burstcount -> BT_Key_s1_translator:uav_burstcount
	wire          bt_key_s1_agent_rf_source_valid;                          // BT_Key_s1_agent:rf_source_valid -> BT_Key_s1_agent_rsp_fifo:in_valid
	wire  [116:0] bt_key_s1_agent_rf_source_data;                           // BT_Key_s1_agent:rf_source_data -> BT_Key_s1_agent_rsp_fifo:in_data
	wire          bt_key_s1_agent_rf_source_ready;                          // BT_Key_s1_agent_rsp_fifo:in_ready -> BT_Key_s1_agent:rf_source_ready
	wire          bt_key_s1_agent_rf_source_startofpacket;                  // BT_Key_s1_agent:rf_source_startofpacket -> BT_Key_s1_agent_rsp_fifo:in_startofpacket
	wire          bt_key_s1_agent_rf_source_endofpacket;                    // BT_Key_s1_agent:rf_source_endofpacket -> BT_Key_s1_agent_rsp_fifo:in_endofpacket
	wire          bt_key_s1_agent_rsp_fifo_out_valid;                       // BT_Key_s1_agent_rsp_fifo:out_valid -> BT_Key_s1_agent:rf_sink_valid
	wire  [116:0] bt_key_s1_agent_rsp_fifo_out_data;                        // BT_Key_s1_agent_rsp_fifo:out_data -> BT_Key_s1_agent:rf_sink_data
	wire          bt_key_s1_agent_rsp_fifo_out_ready;                       // BT_Key_s1_agent:rf_sink_ready -> BT_Key_s1_agent_rsp_fifo:out_ready
	wire          bt_key_s1_agent_rsp_fifo_out_startofpacket;               // BT_Key_s1_agent_rsp_fifo:out_startofpacket -> BT_Key_s1_agent:rf_sink_startofpacket
	wire          bt_key_s1_agent_rsp_fifo_out_endofpacket;                 // BT_Key_s1_agent_rsp_fifo:out_endofpacket -> BT_Key_s1_agent:rf_sink_endofpacket
	wire          bt_key_s1_agent_rdata_fifo_src_valid;                     // BT_Key_s1_agent:rdata_fifo_src_valid -> BT_Key_s1_agent_rdata_fifo:in_valid
	wire   [33:0] bt_key_s1_agent_rdata_fifo_src_data;                      // BT_Key_s1_agent:rdata_fifo_src_data -> BT_Key_s1_agent_rdata_fifo:in_data
	wire          bt_key_s1_agent_rdata_fifo_src_ready;                     // BT_Key_s1_agent_rdata_fifo:in_ready -> BT_Key_s1_agent:rdata_fifo_src_ready
	...
	wire   [20:0] mode_control_s1_agent_m0_address;                         // Mode_control_s1_agent:m0_address -> Mode_control_s1_translator:uav_address
	...
	wire  [116:0] mode_control_s1_agent_rf_source_data;                     // Mode_control_s1_agent:rf_source_data -> Mode_control_s1_agent_rsp_fifo:in_data
	...
	wire  [116:0] mode_control_s1_agent_rsp_fifo_out_data;                  // Mode_control_s1_agent_rsp_fifo:out_data -> Mode_control_s1_agent:rf_sink_data
	...
	wire          mode_control_s1_agent_rdata_fifo_src_valid;               // Mode_control_s1_agent:rdata_fifo_src_valid -> Mode_control_s1_agent_rdata_fifo:in_valid
	wire   [33:0] mode_control_s1_agent_rdata_fifo_src_data;                // Mode_control_s1_agent:rdata_fifo_src_data -> Mode_control_s1_agent_rdata_fifo:in_data
	wire          mode_control_s1_agent_rdata_fifo_src_ready;               // Mode_control_s1_agent_rdata_fifo:in_ready -> Mode_control_s1_agent:rdata_fifo_src_ready
	wire   [31:0] hc05_uart_s1_agent_m0_readdata;                           // HC05_UART_s1_translator:uav_readdata -> HC05_UART_s1_agent:m0_readdata
	wire          hc05_uart_s1_agent_m0_waitrequest;                        // HC05_UART_s1_translator:uav_waitrequest -> HC05_UART_s1_agent:m0_waitrequest
	wire          hc05_uart_s1_agent_m0_debugaccess;                        // HC05_UART_s1_agent:m0_debugaccess -> HC05_UART_s1_translator:uav_debugaccess
	wire   [20:0] hc05_uart_s1_agent_m0_address;                            // HC05_UART_s1_agent:m0_address -> HC05_UART_s1_translator:uav_address
	wire    [3:0] hc05_uart_s1_agent_m0_byteenable;                         // HC05_UART_s1_agent:m0_byteenable -> HC05_UART_s1_translator:uav_byteenable
	wire          hc05_uart_s1_agent_m0_read;                               // HC05_UART_s1_agent:m0_read -> HC05_UART_s1_translator:uav_read
	wire          hc05_uart_s1_agent_m0_readdatavalid;                      // HC05_UART_s1_translator:uav_readdatavalid -> HC05_UART_s1_agent:m0_readdatavalid
	wire          hc05_uart_s1_agent_m0_lock;                               // HC05_UART_s1_agent:m0_lock -> HC05_UART_s1_translator:uav_lock
	wire   [31:0] hc05_uart_s1_agent_m0_writedata;                          // HC05_UART_s1_agent:m0_writedata -> HC05_UART_s1_translator:uav_writedata
	wire          hc05_uart_s1_agent_m0_write;                              // HC05_UART_s1_agent:m0_write -> HC05_UART_s1_translator:uav_write
	wire    [2:0] hc05_uart_s1_agent_m0_burstcount;                         // HC05_UART_s1_agent:m0_burstcount -> HC05_UART_s1_translator:uav_burstcount
	wire          hc05_uart_s1_agent_rf_source_valid;                       // HC05_UART_s1_agent:rf_source_valid -> HC05_UART_s1_agent_rsp_fifo:in_valid
	wire  [116:0] hc05_uart_s1_agent_rf_source_data;                        // HC05_UART_s1_agent:rf_source_data -> HC05_UART_s1_agent_rsp_fifo:in_data
	wire          hc05_uart_s1_agent_rf_source_ready;                       // HC05_UART_s1_agent_rsp_fifo:in_ready -> HC05_UART_s1_agent:rf_source_ready
	wire          hc05_uart_s1_agent_rf_source_startofpacket;               // HC05_UART_s1_agent:rf_source_startofpacket -> HC05_UART_s1_agent_rsp_fifo:in_startofpacket
	wire          hc05_uart_s1_agent_rf_source_endofpacket;                 // HC05_UART_s1_agent:rf_source_endofpacket -> HC05_UART_s1_agent_rsp_fifo:in_endofpacket
	wire          hc05_uart_s1_agent_rsp_fifo_out_valid;                    // HC05_UART_s1_agent_rsp_fifo:out_valid -> HC05_UART_s1_agent:rf_sink_valid
	wire  [116:0] hc05_uart_s1_agent_rsp_fifo_out_data;                     // HC05_UART_s1_agent_rsp_fifo:out_data -> HC05_UART_s1_agent:rf_sink_data
	wire          hc05_uart_s1_agent_rsp_fifo_out_ready;                    // HC05_UART_s1_agent:rf_sink_ready -> HC05_UART_s1_agent_rsp_fifo:out_ready
	wire          hc05_uart_s1_agent_rsp_fifo_out_startofpacket;            // HC05_UART_s1_agent_rsp_fifo:out_startofpacket -> HC05_UART_s1_agent:rf_sink_startofpacket
	wire          hc05_uart_s1_agent_rsp_fifo_out_endofpacket;              // HC05_UART_s1_agent_rsp_fifo:out_endofpacket -> HC05_UART_s1_agent:rf_sink_endofpacket
	wire          hc05_uart_s1_agent_rdata_fifo_src_valid;                  // HC05_UART_s1_agent:rdata_fifo_src_valid -> HC05_UART_s1_agent_rdata_fifo:in_valid
	wire   [33:0] hc05_uart_s1_agent_rdata_fifo_src_data;                   // HC05_UART_s1_agent:rdata_fifo_src_data -> HC05_UART_s1_agent_rdata_fifo:in_data
	wire          hc05_uart_s1_agent_rdata_fifo_src_ready;                  // HC05_UART_s1_agent_rdata_fifo:in_ready -> HC05_UART_s1_agent:rdata_fifo_src_ready
	...
	wire  [115:0] leds_s1_agent_rp_data;                                    // leds_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [115:0] onchip_memory2_0_s1_agent_rp_data;                        // onchip_memory2_0_s1_agent:rp_data -> router_003:sink_data
	...
	wire          bt_key_s1_agent_rp_valid;                                 // BT_Key_s1_agent:rp_valid -> router_004:sink_valid
	wire  [115:0] bt_key_s1_agent_rp_data;                                  // BT_Key_s1_agent:rp_data -> router_004:sink_data
	wire          bt_key_s1_agent_rp_ready;                                 // router_004:sink_ready -> BT_Key_s1_agent:rp_ready
	wire          bt_key_s1_agent_rp_startofpacket;                         // BT_Key_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          bt_key_s1_agent_rp_endofpacket;                           // BT_Key_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [115:0] mode_control_s1_agent_rp_data;                            // Mode_control_s1_agent:rp_data -> router_005:sink_data
	...
	wire          hc05_uart_s1_agent_rp_valid;                              // HC05_UART_s1_agent:rp_valid -> router_006:sink_valid
	wire  [115:0] hc05_uart_s1_agent_rp_data;                               // HC05_UART_s1_agent:rp_data -> router_006:sink_data
	wire          hc05_uart_s1_agent_rp_ready;                              // router_006:sink_ready -> HC05_UART_s1_agent:rp_ready
	wire          hc05_uart_s1_agent_rp_startofpacket;                      // HC05_UART_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          hc05_uart_s1_agent_rp_endofpacket;                        // HC05_UART_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [115:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> leds_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // leds_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> leds_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> onchip_memory2_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // onchip_memory2_0_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> onchip_memory2_0_s1_burst_adapter:sink0_channel
	...
	wire  [115:0] onchip_memory2_0_s1_burst_adapter_source0_data;           // onchip_memory2_0_s1_burst_adapter:source0_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire          cmd_mux_002_src_valid;                                    // cmd_mux_002:src_valid -> BT_Key_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_002_src_data;                                     // cmd_mux_002:src_data -> BT_Key_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                    // BT_Key_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                  // cmd_mux_002:src_channel -> BT_Key_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                            // cmd_mux_002:src_startofpacket -> BT_Key_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                              // cmd_mux_002:src_endofpacket -> BT_Key_s1_burst_adapter:sink0_endofpacket
	wire          bt_key_s1_burst_adapter_source0_valid;                    // BT_Key_s1_burst_adapter:source0_valid -> BT_Key_s1_agent:cp_valid
	wire  [115:0] bt_key_s1_burst_adapter_source0_data;                     // BT_Key_s1_burst_adapter:source0_data -> BT_Key_s1_agent:cp_data
	wire          bt_key_s1_burst_adapter_source0_ready;                    // BT_Key_s1_agent:cp_ready -> BT_Key_s1_burst_adapter:source0_ready
	wire    [4:0] bt_key_s1_burst_adapter_source0_channel;                  // BT_Key_s1_burst_adapter:source0_channel -> BT_Key_s1_agent:cp_channel
	wire          bt_key_s1_burst_adapter_source0_startofpacket;            // BT_Key_s1_burst_adapter:source0_startofpacket -> BT_Key_s1_agent:cp_startofpacket
	wire          bt_key_s1_burst_adapter_source0_endofpacket;              // BT_Key_s1_burst_adapter:source0_endofpacket -> BT_Key_s1_agent:cp_endofpacket
	wire          cmd_mux_003_src_valid;                                    // cmd_mux_003:src_valid -> Mode_control_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_003_src_data;                                     // cmd_mux_003:src_data -> Mode_control_s1_burst_adapter:sink0_data
	wire          cmd_mux_003_src_ready;                                    // Mode_control_s1_burst_adapter:sink0_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                  // cmd_mux_003:src_channel -> Mode_control_s1_burst_adapter:sink0_channel
	wire          cmd_mux_003_src_startofpacket;                            // cmd_mux_003:src_startofpacket -> Mode_control_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_003_src_endofpacket;                              // cmd_mux_003:src_endofpacket -> Mode_control_s1_burst_adapter:sink0_endofpacket
	wire          mode_control_s1_burst_adapter_source0_valid;              // Mode_control_s1_burst_adapter:source0_valid -> Mode_control_s1_agent:cp_valid
	wire  [115:0] mode_control_s1_burst_adapter_source0_data;               // Mode_control_s1_burst_adapter:source0_data -> Mode_control_s1_agent:cp_data
	wire          mode_control_s1_burst_adapter_source0_ready;              // Mode_control_s1_agent:cp_ready -> Mode_control_s1_burst_adapter:source0_ready
	wire    [4:0] mode_control_s1_burst_adapter_source0_channel;            // Mode_control_s1_burst_adapter:source0_channel -> Mode_control_s1_agent:cp_channel
	wire          mode_control_s1_burst_adapter_source0_startofpacket;      // Mode_control_s1_burst_adapter:source0_startofpacket -> Mode_control_s1_agent:cp_startofpacket
	wire          mode_control_s1_burst_adapter_source0_endofpacket;        // Mode_control_s1_burst_adapter:source0_endofpacket -> Mode_control_s1_agent:cp_endofpacket
	wire          cmd_mux_004_src_valid;                                    // cmd_mux_004:src_valid -> HC05_UART_s1_burst_adapter:sink0_valid
	wire  [115:0] cmd_mux_004_src_data;                                     // cmd_mux_004:src_data -> HC05_UART_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                    // HC05_UART_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                  // cmd_mux_004:src_channel -> HC05_UART_s1_burst_adapter:sink0_channel
	wire          cmd_mux_004_src_startofpacket;                            // cmd_mux_004:src_startofpacket -> HC05_UART_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_004_src_endofpacket;                              // cmd_mux_004:src_endofpacket -> HC05_UART_s1_burst_adapter:sink0_endofpacket
	wire          hc05_uart_s1_burst_adapter_source0_valid;                 // HC05_UART_s1_burst_adapter:source0_valid -> HC05_UART_s1_agent:cp_valid
	wire  [115:0] hc05_uart_s1_burst_adapter_source0_data;                  // HC05_UART_s1_burst_adapter:source0_data -> HC05_UART_s1_agent:cp_data
	wire          hc05_uart_s1_burst_adapter_source0_ready;                 // HC05_UART_s1_agent:cp_ready -> HC05_UART_s1_burst_adapter:source0_ready
	wire    [4:0] hc05_uart_s1_burst_adapter_source0_channel;               // HC05_UART_s1_burst_adapter:source0_channel -> HC05_UART_s1_agent:cp_channel
	wire          hc05_uart_s1_burst_adapter_source0_startofpacket;         // HC05_UART_s1_burst_adapter:source0_startofpacket -> HC05_UART_s1_agent:cp_startofpacket
	wire          hc05_uart_s1_burst_adapter_source0_endofpacket;           // HC05_UART_s1_burst_adapter:source0_endofpacket -> HC05_UART_s1_agent:cp_endofpacket
	...
	wire          bt_key_s1_agent_rdata_fifo_out_valid;                     // BT_Key_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] bt_key_s1_agent_rdata_fifo_out_data;                      // BT_Key_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          bt_key_s1_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_002:in_0_ready -> BT_Key_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                        // avalon_st_adapter_002:out_0_valid -> BT_Key_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                         // avalon_st_adapter_002:out_0_data -> BT_Key_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                        // BT_Key_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                        // avalon_st_adapter_002:out_0_error -> BT_Key_s1_agent:rdata_fifo_sink_error
	wire          mode_control_s1_agent_rdata_fifo_out_valid;               // Mode_control_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] mode_control_s1_agent_rdata_fifo_out_data;                // Mode_control_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_003:in_0_data
	wire          mode_control_s1_agent_rdata_fifo_out_ready;               // avalon_st_adapter_003:in_0_ready -> Mode_control_s1_agent_rdata_fifo:out_ready
	...
	wire          hc05_uart_s1_agent_rdata_fifo_out_valid;                  // HC05_UART_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] hc05_uart_s1_agent_rdata_fifo_out_data;                   // HC05_UART_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_004:in_0_data
	wire          hc05_uart_s1_agent_rdata_fifo_out_ready;                  // avalon_st_adapter_004:in_0_ready -> HC05_UART_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_004_out_0_valid;                        // avalon_st_adapter_004:out_0_valid -> HC05_UART_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                         // avalon_st_adapter_004:out_0_data -> HC05_UART_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                        // HC05_UART_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                        // avalon_st_adapter_004:out_0_error -> HC05_UART_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) bt_key_s1_translator (
		.clk                    (clk_0_clk_clk),                          //                      clk.clk
		.reset                  (leds_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (bt_key_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (bt_key_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (bt_key_s1_agent_m0_read),                //                         .read
		.uav_write              (bt_key_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (bt_key_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (bt_key_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (bt_key_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (bt_key_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (bt_key_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (bt_key_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (bt_key_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (BT_Key_s1_address),                      //      avalon_anti_slave_0.address
		.av_readdata            (BT_Key_s1_readdata),                     //                         .readdata
		.av_write               (),                                       //              (terminated)
		.av_read                (),                                       //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) hc05_uart_s1_translator (
		.clk                    (clk_0_clk_clk),                          //                      clk.clk
		.reset                  (leds_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (hc05_uart_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (hc05_uart_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (hc05_uart_s1_agent_m0_read),             //                         .read
		.uav_write              (hc05_uart_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (hc05_uart_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (hc05_uart_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (hc05_uart_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (hc05_uart_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (hc05_uart_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (hc05_uart_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (hc05_uart_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (HC05_UART_s1_address),                   //      avalon_anti_slave_0.address
		.av_write               (HC05_UART_s1_write),                     //                         .write
		.av_read                (HC05_UART_s1_read),                      //                         .read
		.av_readdata            (HC05_UART_s1_readdata),                  //                         .readdata
		.av_writedata           (HC05_UART_s1_writedata),                 //                         .writedata
		.av_begintransfer       (HC05_UART_s1_begintransfer),             //                         .begintransfer
		.av_chipselect          (HC05_UART_s1_chipselect),                //                         .chipselect
		.av_beginbursttransfer  (),                                       //              (terminated)
		.av_burstcount          (),                                       //              (terminated)
		.av_byteenable          (),                                       //              (terminated)
		.av_readdatavalid       (1'b0),                                   //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (leds_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (bt_key_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (bt_key_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (bt_key_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (bt_key_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (bt_key_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (bt_key_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (bt_key_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (bt_key_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (bt_key_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (bt_key_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (bt_key_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (bt_key_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (bt_key_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (bt_key_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (bt_key_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (bt_key_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (bt_key_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (bt_key_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (bt_key_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (bt_key_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (bt_key_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (bt_key_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (bt_key_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (bt_key_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (bt_key_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (bt_key_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (bt_key_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (bt_key_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (bt_key_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (bt_key_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (bt_key_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (bt_key_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),             //                .error
		.rdata_fifo_src_ready    (bt_key_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (bt_key_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (bt_key_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) bt_key_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (leds_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (bt_key_s1_agent_rf_source_data),             //        in.data
		.in_valid          (bt_key_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (bt_key_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (bt_key_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (bt_key_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (bt_key_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (bt_key_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (bt_key_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (bt_key_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (bt_key_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) bt_key_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                          //       clk.clk
		.reset             (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (bt_key_s1_agent_rdata_fifo_src_data),    //        in.data
		.in_valid          (bt_key_s1_agent_rdata_fifo_src_valid),   //          .valid
		.in_ready          (bt_key_s1_agent_rdata_fifo_src_ready),   //          .ready
		.out_data          (bt_key_s1_agent_rdata_fifo_out_data),    //       out.data
		.out_valid         (bt_key_s1_agent_rdata_fifo_out_valid),   //          .valid
		.out_ready         (bt_key_s1_agent_rdata_fifo_out_ready),   //          .ready
		.csr_address       (2'b00),                                  // (terminated)
		.csr_read          (1'b0),                                   // (terminated)
		.csr_write         (1'b0),                                   // (terminated)
		.csr_readdata      (),                                       // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (mode_control_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (mode_control_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (mode_control_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (mode_control_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (mode_control_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (mode_control_s1_burst_adapter_source0_channel),       //                .channel
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) mode_control_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (leds_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (mode_control_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (mode_control_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (mode_control_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (mode_control_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (mode_control_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (mode_control_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                    //             clk.clk
		.reset                   (leds_reset_reset_bridge_in_reset_reset),           //       clk_reset.reset
		.m0_address              (hc05_uart_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (hc05_uart_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (hc05_uart_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (hc05_uart_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (hc05_uart_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (hc05_uart_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (hc05_uart_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (hc05_uart_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (hc05_uart_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (hc05_uart_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (hc05_uart_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (hc05_uart_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (hc05_uart_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (hc05_uart_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (hc05_uart_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (hc05_uart_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (hc05_uart_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (hc05_uart_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (hc05_uart_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (hc05_uart_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (hc05_uart_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (hc05_uart_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (hc05_uart_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (hc05_uart_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (hc05_uart_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (hc05_uart_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (hc05_uart_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (hc05_uart_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (hc05_uart_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (hc05_uart_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (hc05_uart_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (hc05_uart_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_004_out_0_ready),                // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_004_out_0_valid),                //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_004_out_0_data),                 //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_004_out_0_error),                //                .error
		.rdata_fifo_src_ready    (hc05_uart_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (hc05_uart_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (hc05_uart_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                            //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                              //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) hc05_uart_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (leds_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (hc05_uart_s1_agent_rf_source_data),             //        in.data
		.in_valid          (hc05_uart_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (hc05_uart_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (hc05_uart_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (hc05_uart_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (hc05_uart_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (hc05_uart_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (hc05_uart_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (hc05_uart_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (hc05_uart_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                         // (terminated)
		.csr_read          (1'b0),                                          // (terminated)
		.csr_write         (1'b0),                                          // (terminated)
		.csr_readdata      (),                                              // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) hc05_uart_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                           //       clk.clk
		.reset             (leds_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (hc05_uart_s1_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (hc05_uart_s1_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (hc05_uart_s1_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (hc05_uart_s1_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (hc05_uart_s1_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (hc05_uart_s1_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                   // (terminated)
		.csr_read          (1'b0),                                    // (terminated)
		.csr_write         (1'b0),                                    // (terminated)
		.csr_readdata      (),                                        // (terminated)
	...
	soc_system_mm_interconnect_0_router_002 router_004 (
		.sink_ready         (bt_key_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (bt_key_s1_agent_rp_valid),               //          .valid
		.sink_data          (bt_key_s1_agent_rp_data),                //          .data
		.sink_startofpacket (bt_key_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (bt_key_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_router_002 router_006 (
		.sink_ready         (hc05_uart_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (hc05_uart_s1_agent_rp_valid),            //          .valid
		.sink_data          (hc05_uart_s1_agent_rp_data),             //          .data
		.sink_startofpacket (hc05_uart_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (hc05_uart_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (bt_key_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (bt_key_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (bt_key_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (bt_key_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (bt_key_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (bt_key_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (mode_control_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (mode_control_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (mode_control_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (mode_control_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (mode_control_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (mode_control_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (hc05_uart_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (hc05_uart_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (hc05_uart_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (hc05_uart_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (hc05_uart_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (hc05_uart_s1_burst_adapter_source0_ready)          //          .ready
	);
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (leds_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (bt_key_s1_agent_rdata_fifo_out_data),    //     in_0.data
		.in_0_valid     (bt_key_s1_agent_rdata_fifo_out_valid),   //         .valid
		.in_0_ready     (bt_key_s1_agent_rdata_fifo_out_ready),   //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (leds_reset_reset_bridge_in_reset_reset),     // in_rst_0.reset
		.in_0_data      (mode_control_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (mode_control_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (mode_control_s1_agent_rdata_fifo_out_ready), //         .ready
	...
	soc_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                           // in_clk_0.clk
		.in_rst_0_reset (leds_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (hc05_uart_s1_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (hc05_uart_s1_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (hc05_uart_s1_agent_rdata_fifo_out_ready), //         .ready
