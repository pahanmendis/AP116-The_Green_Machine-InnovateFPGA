// GreenMachine_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module GreenMachine_mm_interconnect_0 (
	...
	wire   [29:0] hc05_uart_s1_agent_m0_address;                           // hc05_uart_s1_agent:m0_address -> hc05_uart_s1_translator:uav_address
	...
	wire  [123:0] hc05_uart_s1_agent_rf_source_data;                       // hc05_uart_s1_agent:rf_source_data -> hc05_uart_s1_agent_rsp_fifo:in_data
	...
	wire  [123:0] hc05_uart_s1_agent_rsp_fifo_out_data;                    // hc05_uart_s1_agent_rsp_fifo:out_data -> hc05_uart_s1_agent:rf_sink_data
	...
	wire          hc05_uart_s1_agent_rp_valid;                             // hc05_uart_s1_agent:rp_valid -> router_003:sink_valid
	wire  [122:0] hc05_uart_s1_agent_rp_data;                              // hc05_uart_s1_agent:rp_data -> router_003:sink_data
	wire          hc05_uart_s1_agent_rp_ready;                             // router_003:sink_ready -> hc05_uart_s1_agent:rp_ready
	wire          hc05_uart_s1_agent_rp_startofpacket;                     // hc05_uart_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          hc05_uart_s1_agent_rp_endofpacket;                       // hc05_uart_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [122:0] hc05_uart_s1_burst_adapter_source0_data;                 // hc05_uart_s1_burst_adapter:source0_data -> hc05_uart_s1_agent:cp_data
	wire          hc05_uart_s1_burst_adapter_source0_ready;                // hc05_uart_s1_agent:cp_ready -> hc05_uart_s1_burst_adapter:source0_ready
	wire    [1:0] hc05_uart_s1_burst_adapter_source0_channel;              // hc05_uart_s1_burst_adapter:source0_channel -> hc05_uart_s1_agent:cp_channel
	...
	wire          router_003_src_valid;                                    // router_003:src_valid -> hc05_uart_s1_rsp_width_adapter:in_valid
	wire  [122:0] router_003_src_data;                                     // router_003:src_data -> hc05_uart_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                    // hc05_uart_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                  // router_003:src_channel -> hc05_uart_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                            // router_003:src_startofpacket -> hc05_uart_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                              // router_003:src_endofpacket -> hc05_uart_s1_rsp_width_adapter:in_endofpacket
	wire          hc05_uart_s1_rsp_width_adapter_src_valid;                // hc05_uart_s1_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [158:0] hc05_uart_s1_rsp_width_adapter_src_data;                 // hc05_uart_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          hc05_uart_s1_rsp_width_adapter_src_ready;                // rsp_demux_001:sink_ready -> hc05_uart_s1_rsp_width_adapter:out_ready
	wire    [1:0] hc05_uart_s1_rsp_width_adapter_src_channel;              // hc05_uart_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          hc05_uart_s1_rsp_width_adapter_src_startofpacket;        // hc05_uart_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          hc05_uart_s1_rsp_width_adapter_src_endofpacket;          // hc05_uart_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                   // cmd_mux_001:src_valid -> hc05_uart_s1_cmd_width_adapter:in_valid
	wire  [158:0] cmd_mux_001_src_data;                                    // cmd_mux_001:src_data -> hc05_uart_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                   // hc05_uart_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                 // cmd_mux_001:src_channel -> hc05_uart_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                           // cmd_mux_001:src_startofpacket -> hc05_uart_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                             // cmd_mux_001:src_endofpacket -> hc05_uart_s1_cmd_width_adapter:in_endofpacket
	wire          hc05_uart_s1_cmd_width_adapter_src_valid;                // hc05_uart_s1_cmd_width_adapter:out_valid -> hc05_uart_s1_burst_adapter:sink0_valid
	wire  [122:0] hc05_uart_s1_cmd_width_adapter_src_data;                 // hc05_uart_s1_cmd_width_adapter:out_data -> hc05_uart_s1_burst_adapter:sink0_data
	wire          hc05_uart_s1_cmd_width_adapter_src_ready;                // hc05_uart_s1_burst_adapter:sink0_ready -> hc05_uart_s1_cmd_width_adapter:out_ready
	wire    [1:0] hc05_uart_s1_cmd_width_adapter_src_channel;              // hc05_uart_s1_cmd_width_adapter:out_channel -> hc05_uart_s1_burst_adapter:sink0_channel
	wire          hc05_uart_s1_cmd_width_adapter_src_startofpacket;        // hc05_uart_s1_cmd_width_adapter:out_startofpacket -> hc05_uart_s1_burst_adapter:sink0_startofpacket
	wire          hc05_uart_s1_cmd_width_adapter_src_endofpacket;          // hc05_uart_s1_cmd_width_adapter:out_endofpacket -> hc05_uart_s1_burst_adapter:sink0_endofpacket
	...
	wire          hc05_uart_s1_agent_rdata_fifo_out_valid;                 // hc05_uart_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] hc05_uart_s1_agent_rdata_fifo_out_data;                  // hc05_uart_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          hc05_uart_s1_agent_rdata_fifo_out_ready;                 // avalon_st_adapter_001:in_0_ready -> hc05_uart_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                       // avalon_st_adapter_001:out_0_valid -> hc05_uart_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                        // avalon_st_adapter_001:out_0_data -> hc05_uart_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                       // hc05_uart_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                       // avalon_st_adapter_001:out_0_error -> hc05_uart_s1_agent:rdata_fifo_sink_error
	...
	GreenMachine_mm_interconnect_0_router router (
	...
	GreenMachine_mm_interconnect_0_router router_001 (
	...
	GreenMachine_mm_interconnect_0_router_002 router_002 (
	...
	GreenMachine_mm_interconnect_0_router_002 router_003 (
	...
	altera_merlin_burst_adapter #(
		...
		.clk                   (clk_0_clk_clk),                                       //       cr0.clk
		.reset                 (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // cr0_reset.reset
		.sink0_valid           (hc05_uart_s1_cmd_width_adapter_src_valid),            //     sink0.valid
		.sink0_data            (hc05_uart_s1_cmd_width_adapter_src_data),             //          .data
		.sink0_channel         (hc05_uart_s1_cmd_width_adapter_src_channel),          //          .channel
		.sink0_startofpacket   (hc05_uart_s1_cmd_width_adapter_src_startofpacket),    //          .startofpacket
		.sink0_endofpacket     (hc05_uart_s1_cmd_width_adapter_src_endofpacket),      //          .endofpacket
		.sink0_ready           (hc05_uart_s1_cmd_width_adapter_src_ready),            //          .ready
	...
	GreenMachine_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                    //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	GreenMachine_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //        clk.clk
		.reset              (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	GreenMachine_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	GreenMachine_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                       //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		.sink_ready         (hc05_uart_s1_rsp_width_adapter_src_ready),            //      sink.ready
		.sink_channel       (hc05_uart_s1_rsp_width_adapter_src_channel),          //          .channel
		.sink_data          (hc05_uart_s1_rsp_width_adapter_src_data),             //          .data
		.sink_startofpacket (hc05_uart_s1_rsp_width_adapter_src_startofpacket),    //          .startofpacket
		.sink_endofpacket   (hc05_uart_s1_rsp_width_adapter_src_endofpacket),      //          .endofpacket
		.sink_valid         (hc05_uart_s1_rsp_width_adapter_src_valid),            //          .valid
	...
	GreenMachine_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                    //       clk.clk
		.reset               (hps_0_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) hc05_uart_s1_rsp_width_adapter (
		.clk                  (clk_0_clk_clk),                                       //       clk.clk
		.reset                (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.out_endofpacket      (hc05_uart_s1_rsp_width_adapter_src_endofpacket),      //       src.endofpacket
		.out_data             (hc05_uart_s1_rsp_width_adapter_src_data),             //          .data
		.out_channel          (hc05_uart_s1_rsp_width_adapter_src_channel),          //          .channel
		.out_valid            (hc05_uart_s1_rsp_width_adapter_src_valid),            //          .valid
		.out_ready            (hc05_uart_s1_rsp_width_adapter_src_ready),            //          .ready
		.out_startofpacket    (hc05_uart_s1_rsp_width_adapter_src_startofpacket),    //          .startofpacket
		.in_command_size_data (3'b000)                                               // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) hc05_uart_s1_cmd_width_adapter (
		.clk                  (clk_0_clk_clk),                                       //       clk.clk
		.reset                (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
		...
		.out_endofpacket      (hc05_uart_s1_cmd_width_adapter_src_endofpacket),      //       src.endofpacket
		.out_data             (hc05_uart_s1_cmd_width_adapter_src_data),             //          .data
		.out_channel          (hc05_uart_s1_cmd_width_adapter_src_channel),          //          .channel
		.out_valid            (hc05_uart_s1_cmd_width_adapter_src_valid),            //          .valid
		.out_ready            (hc05_uart_s1_cmd_width_adapter_src_ready),            //          .ready
		.out_startofpacket    (hc05_uart_s1_cmd_width_adapter_src_startofpacket),    //          .startofpacket
		.in_command_size_data (3'b000)                                               // (terminated)
	);

	GreenMachine_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
