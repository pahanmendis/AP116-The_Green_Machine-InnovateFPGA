// GreenMachine_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module GreenMachine_mm_interconnect_1 (
		...
		input  wire        pio_key_reset_reset_bridge_in_reset_reset,                           //                           pio_key_reset_reset_bridge_in_reset.reset
	...
	wire  [112:0] mode_control_s1_agent_rf_source_data;                     // mode_control_s1_agent:rf_source_data -> mode_control_s1_agent_rsp_fifo:in_data
	...
	wire  [112:0] mode_control_s1_agent_rsp_fifo_out_data;                  // mode_control_s1_agent_rsp_fifo:out_data -> mode_control_s1_agent:rf_sink_data
	...
	wire  [111:0] pio_key_s1_agent_rp_data;                                 // pio_key_s1_agent:rp_data -> router_002:sink_data
	...
	wire          mode_control_s1_agent_rp_valid;                           // mode_control_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] mode_control_s1_agent_rp_data;                            // mode_control_s1_agent:rp_data -> router_003:sink_data
	wire          mode_control_s1_agent_rp_ready;                           // router_003:sink_ready -> mode_control_s1_agent:rp_ready
	wire          mode_control_s1_agent_rp_startofpacket;                   // mode_control_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          mode_control_s1_agent_rp_endofpacket;                     // mode_control_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> pio_key_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> pio_key_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // pio_key_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> pio_key_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> pio_key_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> pio_key_s1_burst_adapter:sink0_endofpacket
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> mode_control_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> mode_control_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // mode_control_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> mode_control_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> mode_control_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> mode_control_s1_burst_adapter:sink0_endofpacket
	...
	wire  [111:0] mode_control_s1_burst_adapter_source0_data;               // mode_control_s1_burst_adapter:source0_data -> mode_control_s1_agent:cp_data
	...
	wire    [1:0] mode_control_s1_burst_adapter_source0_channel;            // mode_control_s1_burst_adapter:source0_channel -> mode_control_s1_agent:cp_channel
	...
	wire          pio_key_s1_agent_rdata_fifo_out_valid;                    // pio_key_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] pio_key_s1_agent_rdata_fifo_out_data;                     // pio_key_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          pio_key_s1_agent_rdata_fifo_out_ready;                    // avalon_st_adapter:in_0_ready -> pio_key_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> pio_key_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> pio_key_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // pio_key_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> pio_key_s1_agent:rdata_fifo_sink_error
	wire          mode_control_s1_agent_rdata_fifo_out_valid;               // mode_control_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] mode_control_s1_agent_rdata_fifo_out_data;                // mode_control_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          mode_control_s1_agent_rdata_fifo_out_ready;               // avalon_st_adapter_001:in_0_ready -> mode_control_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> mode_control_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> mode_control_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // mode_control_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> mode_control_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (pio_key_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (pio_key_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	GreenMachine_mm_interconnect_1_router router (
	...
	GreenMachine_mm_interconnect_1_router router_001 (
	...
	GreenMachine_mm_interconnect_1_router_002 router_002 (
	...
	GreenMachine_mm_interconnect_1_router_002 router_003 (
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (pio_key_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	GreenMachine_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	GreenMachine_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	GreenMachine_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (pio_key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (pio_key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (pio_key_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	GreenMachine_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (pio_key_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
